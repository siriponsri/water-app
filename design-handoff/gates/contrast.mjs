...
/* Works both inside the full project and standalone in design-handoff/. */
const tokensPath = [
  path.join(here, '..', 'apps', 'web', 'src', 'tokens.css'),
  path.join(here, '..', 'css', 'tokens.css')
].find((candidate) => existsSync(candidate));
if (!tokensPath) throw new Error('tokens.css not found beside this gate');
